...
public class FlowMgmt101 : MonoBehaviour
{
    ...
    public void FlowerTopUp()
    {
        ...
        if (getFlowerTopUp == true)
        {
            ...
            else if (flowGroup == 7)
            {
                ...
                Flower_Anim flowerScript1 = flow15.GetComponent<Flower_Anim>();
                flow2TopUp = flowerScript1.flowerDrained;
                flow2HitMeUp = flowerScript1.hitMeUp + hitMeUp;
            ...
            else if (flowGroup == 8)
            {
                ...
                Flower_Anim flowerScript1 = flow17.GetComponent<Flower_Anim>();
                flow2TopUp = flowerScript1.flowerDrained;
                flow2HitMeUp = flowerScript1.hitMeUp + hitMeUp;
            ...
            if(flowGroup == 9)
            {
                ...
                //22/10/2019 GOT HERE! ADD ONE FLOWER
    ...
    public void FlowSpawn()
    {
        ...
        if (nextFlower == 6)
        {
            ...
            Flower_Anim flowAnimScript1 = flow8.GetComponent<Flower_Anim>();
        ...
        if (nextFlower == 10)
        {
            ...
            Flower_Anim flowAnimScript1 = flow12.GetComponent<Flower_Anim>();
            flowAnimDone2 = flowAnimScript1.animDone;
        ...
        if(nextFlower == 15)
        {
            ...
            Flower_Anim flowAnimScript1 = flow17.GetComponent<Flower_Anim>();
            flowAnimDone2 = flowAnimScript1.animDone;
