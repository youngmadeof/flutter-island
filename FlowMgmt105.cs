...
public class FlowMgmt105 : MonoBehaviour
{
    ...
    public void FlowerTopUp()
    {
        ...
        if (getFlowerTopUp == true)
        {
            ...
            else if (flowGroup == 1)
            {
                ...
                Flower_Anim flowerScript2 = flow5.GetComponent<Flower_Anim>();
                flow2TopUp = flowerScript2.flowerDrained;
                flow2HitMeUp = flowerScript2.hitMeUp + hitMeUp;

                Flower_Anim flowerScript3 = flow6.GetComponent<Flower_Anim>();
            ...
            else if (flowGroup == 2)
            {
                ...
                Flower_Anim flowerScript1 = flow8.GetComponent<Flower_Anim>();
                flow2TopUp = flowerScript1.flowerDrained;
                flow2HitMeUp = flowerScript1.hitMeUp + hitMeUp;
            ...
            else if (flowGroup == 3)
            {
                ...
                Flower_Anim flowerScript1 = flow10.GetComponent<Flower_Anim>();
                flow2TopUp = flowerScript1.flowerDrained;
                flow2HitMeUp = flowerScript1.hitMeUp + hitMeUp;
            ...
            else if (flowGroup == 4)
            {
                ...
                Flower_Anim flowerScript4 = flow14.GetComponent<Flower_Anim>();
            ...
            {
                Flower_Anim flowerScript = flow16.GetComponent<Flower_Anim>();
                flow1TopUp = flowerScript.flowerDrained;
                flow1HitMeUp = flowerScript.hitMeUp + hitMeUp;
            ...
            else if (flowGroup == 7)
            {
                ...
                if(flow3TopUp == true && flowDone3 == false)
                {
                    ...
                    if (flowDone2 == true && flowDone1 == true)
                    {
                        lastFlow = true;
                    }
                    HitMeUp();
    ...
    public void FlowSpawn()
    {
        if (nextFlower == 0)
        {
            ...
            Flower_Anim flowAnimScript2 = flow2.GetComponent<Flower_Anim>();
        ...
        if (nextFlower == 10)
        {
            ...
            Flower_Anim flowAnimScript2 = flow12.GetComponent<Flower_Anim>();
            flowAnimDone2 = flowAnimScript2.animDone;
            ...
            Flower_Anim flowAnimScript3 = flow13.GetComponent<Flower_Anim>();
        ...
        if (nextFlower == 15)
        {
            ...
            Flower_Anim flowAnimScript = flow16.GetComponent<Flower_Anim>();
            flowAnimDone = flowAnimScript.animDone;
        ...
        if (nextFlower == 17)
        {
            ...
            Flower_Anim flowAnimScript2 = flow19.GetComponent<Flower_Anim>();
            flowAnimDone2 = flowAnimScript2.animDone;
