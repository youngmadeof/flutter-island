...
public class FlowMgmt104 : MonoBehaviour
{
    ...
    public void FlowerTopUp()
    {
        ...
        if (getFlowerTopUp == true)
        {
            ...
            else if (flowGroup == 4)
            {
                ...
                Flower_Anim flowerScript2 = flow11.GetComponent<Flower_Anim>();
    ...
    public void FlowSpawn()
    {
        ...
        if (nextFlower == 6)
        {
            ...
            Flower_Anim flowAnimScript2 = flow8.GetComponent<Flower_Anim>();
            flowAnimDone2 = flowAnimScript2.animDone;
